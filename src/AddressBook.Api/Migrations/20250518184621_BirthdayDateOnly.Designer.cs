...
namespace AddressBook.Api.Migrations
{
    ...
    [Migration("20250518184621_BirthdayDateOnly")]
    partial class BirthdayDateOnly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AddressBook.Api.Domain.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AddressBook.Api.Domain.Phone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AddressBook.Api.Domain.PhoneOperator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AddressBook.Api.Domain.Phone", b =>
                {
                    b.HasOne("AddressBook.Api.Domain.Contact", "Contact")
                        .WithMany("Phones")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AddressBook.Api.Domain.PhoneOperator", "PhoneOperator")
                        .WithMany("Phones")

...
1. **Primary Language/Framework**: (e.g., JavaScript/TypeScript, Blazor, C#/.NET, etc.)
2. **Project Type**: (e.g., web app, API, desktop app, library, etc.)
...
- **Frontend Web Development**: Blazor, TypeScript, CSS frameworks
- **C# .NET Development**: Testing, documentation, and best practices
- **Database Development**: Azure SQL, SQL Server, and general database best practices
